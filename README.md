...
- Discover how language models embed meaning into vectors by [exploring the similarities and the geometric landscape](xxx) of `word embeddings` and `embedding layers`.
...
note = {Last updated 07 March 2023},
}
```
