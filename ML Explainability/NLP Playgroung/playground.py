        ...
        dbc.Row([
            dbc.Col([
                dbc.Card([
                    ...
                    html.Br(),
                    dcc.Markdown('**Top-K**', style={'margin-left': '5px'}),
                    dcc.Slider(10, 50, 10,
                               value=10,
                               id='topk-slider'),
                    html.Br(),
